...
class ChatSettings(Object):
    ...
    Parameters:
        ...
        is_paid_messages_enabled (``bool``, *optional*):
            True, if you should pay for messages sent to this chat.

        registration_date (``str``, *optional*):
            Year and month when the user registered.
        ...
        photo_change_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when the photo was changed.
    """
    ...
    def __init__(
        ...
        *,
        ...
        is_paid_messages_enabled: Optional[bool] = None,
        ...
        self.is_paid_messages_enabled = is_paid_messages_enabled
    ...
    def _parse(client, chat_settings: "raw.types.PeerSettings", users) -> Optional["ChatSettings"]:
        ...
        return ChatSettings(
            ...
            is_paid_messages_enabled=getattr(chat_settings, "charge_paid_message_stars", None),
